...
// Test-only hash (sha256 of 'test-pass'); the real hashes ship in accessControl.js
vi.mock('../accessControl.js', async (importOriginal) => {
  const mod = await importOriginal();
  return { ...mod,
    PASSWORD_SHA256S: ['661ea2edce1d4894ab62edb966f83c890f6c90399109e3826193461ce333b5e1'] };
});
