...
PROVIDER_NETWORK = {
    "fbi-cjis": (3600000, 41000, 2.1, 22, 41, 55.0, 0.8,
                 {"J": 52, "D": 16, "G": 19, "H": 13}),
    "equifax": (1150000, 96500, 4.8, 12, 33, 78.5, 1.3, {"F": 100}),
    "experian": (480000, 38200, 4.1, 11, 30, 81.0, 1.4, {"F": 100}),
    "transunion": (1150000, 92800, 5.2, 13, 34, 76.0, 1.2, {"F": 100}),
    "lexisnexis": (2400000, 54600, 3.3, 9, 28, 70.5, 2.4,
                   {"F": 44, "J": 38, "E": 18}),
    "fincen": (3600000, 18400, 1.6, 34, 41, 48.0, 3.6, {"F": 72, "B": 28}),
    "cbp-i94": (3600000, 66300, 2.4, 8, 27, 83.5, 1.1,
                {"B": 41, "C": 36, "E": 23}),
    "courts": (940000, 12700, 6.8, 19, 39, 41.0, 8.7,
               {"J": 42, "D": 13, "G": 17, "H": 9, "F": 19}),
    "dmv": (1800000, 33900, 3.1, 7, 24, 88.0, 2.84, {"G": 63, "J": 37}),
    "irs": (620000, 9400, 5.4, 15, 36, 64.0, 6.3, {"F": 100}),
    "sead5": (210000, 4800, 7.9, 17, 34, 37.5, 4.75,
              {"A": 9, "D": 27, "E": 41, "J": 23}),
    "diss": (2900000, 21500, 1.2, 21, 33, 69.0, 0.9, {"E": 100}),
}
