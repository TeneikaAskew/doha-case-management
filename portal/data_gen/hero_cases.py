...
def _hero1(precedent_fn) -> dict:
    subject = _subject(dict(
        ...
        addressHistory=[
            dict(address="1427 Birch Hollow Ct, Manassas, VA 20109",
                 fromDate="2019-08-10", toDate=None),
            ...
            dict(address="2201 Wilson Blvd Apt 903, Arlington, VA 22201",
                 fromDate="2010-05-15", toDate="2014-06-21"),
        ],
        employmentHistory=[
            dict(employer="Sentinel Dynamics LLC", title="Senior Systems Engineer",
                 ...
                 fromDate="2018-02-05", toDate=None),
            ...
            dict(employer="George Mason University", title="Research Assistant",
                 ...
                 fromDate="2010-08-30", toDate="2012-12-14"),
        ],
    ))
    ...
    roi_url, roi_doc = docs.roi(
        "SUBJ-001", "roi-20260127", case_ref="DCSA-PR-2025-448121",
        inv_type="T5 Periodic Reinvestigation", opened="2025-09-15",
        transmitted="2026-01-27", lead="S. Whitfield",
        office="DCSA Washington Field Office", entries=roi_entries,
        received="2026-01-27")
    alerts = [
        dict(id="ALERT-101", subjectId="SUBJ-001", subjectName=subject["name"],
             ...
             identityMatch=dict(confidence=0.96, identifiers=[
                 dict(field="Name", subjectValue="Daniel R. Okafor",
                      recordValue="OKAFOR, DANIEL", match=True, score=0.97),
                 dict(field="DOB", subjectValue="1988-03-14",
                      recordValue="1988-03-14", match=True, score=1.0),
                 dict(field="SSN", subjectValue="923-04-4821",
                      recordValue="923-04-4821", match=True, score=1.0),
                 dict(field="Phone", subjectValue="(703) 555-0142",
                      recordValue="703-555-0142", match=True, score=0.98),
                 dict(field="Email", subjectValue="d.okafor88@example.com",
                      recordValue="dokafor.va@mailhost.example", match=False,
                      score=0.34),
                 dict(field="Address",
                      subjectValue="1427 Birch Hollow Ct, Manassas, VA 20109",
                      recordValue="1427 BIRCH HOLLOW CT, MANASSAS, VA 20109-2415",
             ...
             history=[dict(state="NEW", date="2026-06-20", actor="System",
        ...
        dict(id="ALERT-102", subjectId="SUBJ-001", subjectName=subject["name"],
             ...
             identityMatch=dict(confidence=0.99, identifiers=[
                 dict(field="Passport", subjectValue="531048291",
                      recordValue="531048291", match=True, score=1.0),
                 dict(field="Name", subjectValue="Daniel R. Okafor",
                      recordValue="OKAFOR, DANIEL R", match=True, score=0.98),
                 dict(field="DOB", subjectValue="1988-03-14",
                      recordValue="1988-03-14", match=True, score=1.0)]),
             ...
             history=[
                 dict(state="NEW", date="2026-05-02", actor="System",
                      note="Alert received via CBP I-94 feed"),
                 dict(state="IDENTITY_CONFIRMED", date="2026-05-04",
                      actor="R. Chen (Analyst)",
                      note="Passport-number match confirmed"),
                 dict(state="VALIDATED", date="2026-05-06",
                      actor="R. Chen (Analyst)",
                      note="No FSO travel report on file; referred to adjudication"),
             ]),
    ]
    return dict(
        subject=subject,
        ...
        investigation=dict(
            recordChecks=[
                dict(item="Subject interview (ESI)", category="SUBJECT_INTERVIEW",
                     status="COMPLETE",
                     ...
                     documentUrl=None),
                dict(item="Employment coverage (10 yrs)", category="EMPLOYMENT",
                     status="COMPLETE",
                     provider="DCSA field operations", requestedDate="2025-10-02",
                     ...
                     documentUrl=None),
                dict(item="Neighborhood/reference interviews", category="REFERENCES",
                     status="COMPLETE",
                     provider="DCSA field operations", requestedDate="2025-10-02",
                     completedDate="2025-12-04",
                ...
                dict(item="Tri-bureau credit re-check", category="FINANCIAL",
                     ...
                     resultSummary="$47,300 delinquent across five accounts; unpaid "
                                   "$3,100 judgment (2025).",
                     documentUrl=cu_url),
                dict(item="SAR registry query", category="FINANCIAL",
                     status="COMPLETE",
                     ...
                     resultSummary="One SAR: structured remittances to Nigeria, "
                                   "Jan-Mar 2026.",
                     documentUrl=sar_url),
                dict(item="Border-crossing records", category="FOREIGN",
                     status="COMPLETE",
                     ...
                     resultSummary="Unreported Nigeria travel 2026-04-11 to "
                                   "2026-04-25.",
                     documentUrl=trv_url),
                dict(item="Foreign contact expansion leads", category="FOREIGN",
                     status="PENDING",
        ...
        documents=[
            dict(title="Report of Investigation (ROI)", type="ROI",
                 description="T5 ROI transmitted 2026-01-27", url=roi_url),
...
def _hero2(precedent_fn) -> dict:
    ...
    alerts = [
        dict(id="ALERT-201", subjectId="SUBJ-002", subjectName=subject["name"],
             ...
             identityMatch=dict(confidence=0.97, identifiers=[
                 dict(field="Fingerprint", subjectValue="Enrolled (Rap Back)",
                      recordValue="Match", match=True, score=1.0),
                 dict(field="Name", subjectValue="Marcus T. Bell",
                      recordValue="BELL, MARCUS T", match=True, score=0.97),
                 dict(field="DOB", subjectValue="1992-11-02",
                      recordValue="1992-11-02", match=True, score=1.0),
                 dict(field="SSN", subjectValue="917-38-7733",
                      recordValue="917-38-7733", match=True, score=1.0),
                 dict(field="Phone", subjectValue="(757) 555-0186",
                      recordValue="757-555-0186", match=True, score=0.98),
                 dict(field="Address",
                      subjectValue="88 Quarry Ridge Rd, Chesapeake, VA 23320",
                      recordValue="88 QUARRY RIDGE RD, CHESAPEAKE, VA 23320",
                      match=True, score=0.96)]),
             ...
             history=[dict(state="NEW", date="2026-06-23", actor="System",
                           note="Rap Back notification received")]),
        dict(id="ALERT-202", subjectId="SUBJ-002", subjectName=subject["name"],
             ...
             identityMatch=dict(confidence=0.95, identifiers=[
                 dict(field="Name", subjectValue="Marcus T. Bell",
                      recordValue="BELL, MARCUS", match=True, score=0.95),
                 dict(field="DOB", subjectValue="1992-11-02",
                      recordValue="1992-11-02", match=True, score=1.0),
                 dict(field="SSN", subjectValue="917-38-7733",
                      recordValue="917-38-7733", match=True, score=1.0),
                 dict(field="Phone", subjectValue="(757) 555-0186",
                      recordValue="Not on bureau file", match=False, score=0.0),
                 dict(field="Email", subjectValue="mtbell92@example.com",
                      recordValue="marcus.bell.hr@tidewater.example", match=False,
                      score=0.29),
                 dict(field="Address",
                      subjectValue="88 Quarry Ridge Rd, Chesapeake, VA 23320",
                      recordValue="414 KEMPSVILLE CROSSING LN, VIRGINIA BEACH, "
                                  "VA 23464",
                      match=False, score=0.58)]),
             ...
             history=[
                 dict(state="NEW", date="2025-10-12", actor="System",
                      note="Alert received via TransUnion CV feed"),
                 dict(state="IDENTITY_CONFIRMED", date="2025-10-20",
                      actor="R. Chen (Analyst)", note=None),
                 dict(state="VALIDATED", date="2025-10-28",
                      actor="R. Chen (Analyst)",
                      note="Delinquency verified; low severity"),
                 dict(state="ADJUDICATED", date="2025-11-20",
                      actor="R. Chen (Analyst)",
    ...
    return dict(
        ...
        investigation=dict(
            recordChecks=[
                dict(item="Criminal history baseline (2023)", category="CRIMINAL",
                     status="COMPLETE",
                     provider="FBI CJIS / NCIC + Rap Back", requestedDate="2023-02-01",
                     completedDate="2023-03-20",
                     scope="NCIC criminal history and DMV - T3 initial investigation",
                     resultSummary="No record at adjudication (2023).",
                     documentUrl=None),
                dict(item="Police report retrieval (2026 arrest)", category="CRIMINAL",
                     status="COMPLETE",
                     ...
                     documentUrl=pr_url),
                dict(item="Court disposition monitoring", category="CRIMINAL",
                     status="PENDING",
                     ...
                     resultSummary="Arraignment scheduled 2026-07-14; disposition "
                                   "pending.",
                     documentUrl=None),
                dict(item="Credit baseline (2023)", category="FINANCIAL",
                     status="COMPLETE",
                     provider="TransUnion", requestedDate="2023-02-01",
                     completedDate="2023-03-20",
                     scope="Tri-bureau credit - T3 initial investigation",
                     resultSummary="All accounts current at adjudication (2023).",
                     documentUrl=None),
            ],
            sf86Sections=[
    ...
    subject = _subject(dict(
        ...
        addressHistory=[
            dict(address="510 Alder Grove Ln, Columbia, MD 21044",
                 fromDate="2022-07-16", toDate=None),
            dict(address="3901 Falls Rd Apt 316, Baltimore, MD 21211",
                 fromDate="2018-08-04", toDate="2022-07-16"),
            dict(address="12 Coventry Ct, Edison, NJ 08820",
                 fromDate="1996-07-22", toDate="2018-08-04"),
        ],
        employmentHistory=[
        ...
        investigation=dict(
            recordChecks=[
                dict(item="Fingerprint / FBI criminal history", status="COMPLETE",
                     ...
                     category="CRIMINAL"),
                dict(item="Credit check", category="FINANCIAL",
                     status="COMPLETE", provider="Equifax",
                     ...
                     documentUrl=cr_url),
                dict(item="Education verification", category="EDUCATION",
                     status="COMPLETE",
                ...
                dict(item="Employment verification", category="EMPLOYMENT",
                     status="PENDING",
                     provider="LexisNexis", requestedDate="2026-06-11",
                     completedDate=None,
                     ...
                     documentUrl=None),
                dict(item="Subject interview", category="SUBJECT_INTERVIEW",
                     status="NOT_REQUIRED",
